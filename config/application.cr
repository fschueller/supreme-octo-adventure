...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Supreme Octo Adventure web application."
  #
  #
  ...
  #
  # settings.secret_key_base= SoFrafpyjAV-moi3mXL5Fp8hcerJ33tPB3VFiH5xJ4g
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("supreme-octo-adventure.log", "w"))
  #
  #
end
